window.onload = function() {
    ...
    else
    {
        ...
        stationStatus.innerHTML = '<div><strong>Statut</strong> : ' + ' ' + '</div>';
        stationName.innerHTML = '<div><strong>Station</strong> : ' + ' ' + '</div>';
        stationAddress.innerHTML = '<div><strong>Adresse</strong> : ' + ' ' + '</div>';
        stationBikeStands.innerHTML = '<div><strong>Places au total</strong> : ' + ' ' + '</div>';
        stationAvailableBikeStands.innerHTML = '<div><strong>Places disponibles</strong> : ' + ' ' + '</div>';
        stationAvailableBikes.innerHTML = '<div><strong>Vélos disponibles</strong> : ' + ' ' + '</div>';

        
        delay = 'Pas de réservation';
        localStorage.setItem('compteur', delay);
        document.getElementById('compteur').innerText = localStorage.getItem('compteur');
        clearInterval(refreshCompt);
    }
    ...
    /*if (M === undefined || S === undefined)
        {
            document.getElementById('compteur').innerText = "Pas de réservation";
        }

    if (M === undefined || S === undefined){delay = "Pas de réservation";}
